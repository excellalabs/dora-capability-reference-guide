...
As you about adopting a DORA capability read the associated documentation on the DORA site. This will help you understand how it fits in with the scope of DORA and its impact on the four key metrics.
